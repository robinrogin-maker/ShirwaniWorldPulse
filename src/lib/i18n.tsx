...
export const T: Dict = {
  ...
  weather: { ar: "الطقس", en: "Weather", sv: "Väder" },
  onthisday: { ar: "حدث في مثل هذا اليوم", en: "On This Day", sv: "Denna dag i historien" },
  cars: { ar: "عالم السيارات", en: "Cars", sv: "Bilvärlden" },
