...
const SOURCE_NAMES = {
  ...
  "anghami.com": "أنغامي",
  // Additional source names for new feeds
  "arabsounds.net": "عرب ساوندز",
...
const RSS_FEEDS = {
  ...
  ar: {
    world: [
      ...
      // مصادر إضافية من الموقع القديم (سياسة/عالم)
      "https://www.skynewsarabia.com/rss.xml",
      "https://www.albawaba.com/rss/ar-news"
    ],
    ...
    health: [
      ...
      // مصادر إضافية من الموقع القديم (طب/صحة)
      "https://www.webteb.com/feed",
      "https://www.albawaba.com/rss/ar-health"
    ],
    cars: [
    ...
    music: [
      "https://arabic.cnn.com/api/v1/rss/music/rss.xml",
      "https://arabsounds.net/blog/feed",
      "https://arabic.euronews.com/rss?level=vertical&name=culture"
    ],
    horoscope: []
  },
